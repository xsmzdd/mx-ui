...
class NodeOutboundItem {
    constructor(data) {
        ...
        this.outboundId = 0;
        this.outboundEnable = false;
        this.outboundProtocol = "socks5";
    ...
    get isValidConfig() {
        return !ObjectUtil.isEmpty(this.outboundAddress) && this.outboundPort > 0;
    }
}